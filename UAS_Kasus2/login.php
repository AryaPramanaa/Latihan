            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="post" action="">
                <div class="form-group">
                  <input type="email" name="email" class="form-control form-control-lg" id="floatingInput" placeholder="Username">
                </div>
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="register.php" class="text-primary">Register</a>
                </div>
              </form>
