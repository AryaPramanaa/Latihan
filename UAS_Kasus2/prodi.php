            ...
            <div class="col-lg-6">
                ...
                <form action="prosesProdi.php?proses=edit&id=<?= $dataProdi['prodiId']?>" method="post">
                    ...
                    <select required name="jenjangStudi" class="form-select mb-3">
                        ...
                        <option <?php if($dataProdi['jenjangStudi'] == "D2") {echo "selected";}?> value="D2">D-2</option>
                        <option <?php if($dataProdi['jenjangStudi'] == "D3") {echo "selected";}?> value="D3">D-3</option>
                        <option <?php if($dataProdi['jenjangStudi'] == "D4") {echo "selected";}?> value="D4">D-4</option>
                        <option <?php if($dataProdi['jenjangStudi'] == "S1") {echo "selected";}?> value="S1">S-1</option>
                        <option <?php if($dataProdi['jenjangStudi'] == "S2") {echo "selected";}?> value="S2">S-2</option>
                        <option <?php if($dataProdi['jenjangStudi'] == "S3") {echo "selected";}?> value="S3">S-3</option>
                    </select>
