                ...
                <div class="col-lg-6">
                    <form action="" method="post">
                        <div class="container" width="500px">
                            ...
                            <div class="row mb-3">
                                <div class="col-3"><input <?php if ($dataMahasiswa['jenisKelamin'] == "L") {
                                                                echo "checked";
                                                            } ?> required type="radio" name="jenisKelamin" value="L" class="form-check-input"> Laki-Laki</div>
                                <div class="col-3"><input <?php if ($dataMahasiswa['jenisKelamin'] == "P") {
                                                                echo "checked";
                                                            } ?> required type="radio" name="jenisKelamin" value="P" class="form-check-input"> Perempuan</div>
                            </div>
                            <select required name="prodi" class="form-select mb-3" aria-label="Default select example">
                                ...
                                while ($data = mysqli_fetch_array($sql)) {
                                ?>
                                    <option <?php if ($dataMahasiswa['prodiId'] == "$data[prodiId]") {
                                                echo "selected";
                                            } ?> value="<?= $data['keterangan'] ?>"><?= $data['namaProdi'] ?></option>
                                <?php } ?>
                            </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-4">
                                    <input <?php if (in_array('Menyanyi', $hobi)) {
                                                echo "checked";
                                            } ?> class="form-check-input" type="checkbox" name="hobi[]" value="Menyanyi" id="menyanyi">
                                    <label class="form-check-label" for="menyanyi">
                                        Menyanyi
                                    </label>
                                </div>
                                <div class="col-lg-4">
                                    <input <?php if (in_array('Mengambar', $hobi)) {
                                                echo "checked";
                                            } ?> class="form-check-input" type="checkbox" name="hobi[]" value="Mengambar" id="Mengambar">
                                    <label class="form-check-label" for="Mengambar">
                                        Mengambar
                                    </label>
                                </div>
                                <div class="col-lg-4">
                                    <input <?php if (in_array('Menari', $hobi)) {
                                                echo "checked";
                                            } ?> class="form-check-input" type="checkbox" name="hobi[]" value="Menari" id="Menari">
                                    <label class="form-check-label" for="Menari">
                                        Menari
                                    </label>
                                </div>
